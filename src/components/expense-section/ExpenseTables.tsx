...
export function ReimbursementTable({ reimbursements, transactions, getCollaboratorName, onDelete }: ReimbursementTableProps) {
  ...
  return (
    <div className="bg-card rounded-2xl border border-border overflow-hidden shadow-xs">
      <div className="p-4 sm:p-5 border-b border-border"><h3 className="text-base font-semibold text-foreground flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500" />Historique des règlements de la dette collaborateur</h3><p className="text-xs text-muted-foreground mt-0.5">Ces remboursements restent des décaissements bancaires mais ne créent aucune nouvelle charge ni TVA.</p></div>
